...
## Status
- In Progress (Phase 1~7 주요 항목 구현 완료, 운영 데이터 기준 성능 재검증 잔여)
...
- (완료) no-op/롤백 정책 테스트 보강
- (완료) 운영 가이드 문서 추가(`docs/operations/ops-audit-logs-guide.md`)
