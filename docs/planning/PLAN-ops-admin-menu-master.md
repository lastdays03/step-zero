...
## 우선순위/구현 순서
1. 공통 기반: 권한/레이아웃/네비게이션/공통 API 클라이언트 + 감사로그 기록 인프라(테이블/유틸)
2. 고리스크 조치: Growth Club, ActionKit (구현 시 감사로그 즉시 연동)
3. 운영 커뮤니케이션: Announcements (구현 시 감사로그 즉시 연동)
4. 추적 체계 조회면: Audit Logs 화면/필터
5. 보조 지표 고도화: Reports
6. 사용자 운영 고도화: Users
