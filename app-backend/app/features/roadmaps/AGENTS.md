# roadmaps Feature Rules

## Scope
- 이 문서는 \'app-backend/app/features/roadmaps/\' 하위에 적용된다.

## Allowed Changes
- \'features/roadmaps/domain\'와 \'features/roadmaps/application\' 내부 구현
- \'app/api/v1/roadmaps/\' 라우팅/스키마 매핑
