      ...
      {expanded && (
        <ul className="mt-1.5 space-y-1">
          {sources.map((src) => (
            ...
            >
              {src.type === "law" || src.type === "legal_basis" ? (
              ...
              <div className="min-w-0">
                <p className="font-medium text-slate-700 truncate">
                  [{src.type === "law" || src.type === "legal_basis" ? "법령" : "서류"}{" "}
                  {src.id}] {src.title}
                </p>
                {src.url && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-0.5 mt-0.5 text-blue-600 hover:underline"
                  >
