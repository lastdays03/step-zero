                                ...
                                {uploading ? (
                                    ...
                                    <div className="flex flex-col items-center justify-center space-y-2 text-slate-500">
                                        ...
                                        <p className="text-xs text-slate-400">
                                            현재 첨부된 파일 버전: v{item.files?.length ? Math.max(...item.files.map((f: ActionKitFileRecord) => f.version)) : "없음"}
                                        </p>
                                    </div>
                                )}
                            </div>
                            ...
                            {item.files?.length > 0 && (
                                <div className="mt-3">
                                    ...
                                    <div className="space-y-1.5 max-h-[160px] overflow-y-auto">
                                        {[...item.files].sort((a: ActionKitFileRecord, b: ActionKitFileRecord) => b.version - a.version).map((f: ActionKitFileRecord) => (
