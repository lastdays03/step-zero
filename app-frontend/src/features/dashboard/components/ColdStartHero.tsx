      ...
      <div className="relative flex flex-col items-center justify-center min-h-[calc(100vh-10rem)] px-6">
        ...
        <div className="relative z-10 max-w-3xl w-full text-center space-y-8">
          ...
          <div className="relative group">
            ...
            <div className="relative flex flex-col md:flex-row items-stretch gap-3 bg-white p-3 rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-200">
              <div className="flex-1 flex items-center px-4 gap-3">
                <Search className="w-5 h-5 text-slate-400 shrink-0" />
                <span className="text-lg text-slate-400 text-left">
              ...
              <button
                type="button"
                onClick={handleStart}
                className="bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-4 rounded-xl font-bold text-base transition-all flex items-center justify-center gap-2 shadow-lg shadow-indigo-600/25"
              >
